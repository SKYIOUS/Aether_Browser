//! Contains [CaelumTree](crate::tree::CaelumTree): the default implementation of [LayoutTree](crate::tree::LayoutTree), and the error type for Caelum.
...
use crate::util::sys::DefaultCheapStr;
use crate::tree::{
...
pub enum CaelumError {
    ...
    /// The parent node was not found in the [`CaelumTree`](crate::CaelumTree) instance.
    InvalidParentNode(NodeId),
    /// The child node was not found in the [`CaelumTree`](crate::CaelumTree) instance.
    InvalidChildNode(NodeId),
    /// The supplied node was not found in the [`CaelumTree`](crate::CaelumTree) instance.
