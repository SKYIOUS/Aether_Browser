...
impl Parser {
    ...
    fn parse_element(&mut self) -> Node {
        let _ = self.consume_char(); // consume <
        ...
        // List of tags that are typically self-closing in HTML
    ...
    fn parse_nodes(&mut self) -> Vec<Node> {
        ...
        loop {
            ...
            // Skip empty text nodes and closing tags
            match &node.node_type {
                crate::engine::dom::NodeType::Text(t) if t.is_empty() => continue,
                crate::engine::dom::NodeType::Text(_) => nodes.push(node),
                crate::engine::dom::NodeType::Comment(_) => continue, // Skip comments
                _ => nodes.push(node),
            }
        }
        nodes
