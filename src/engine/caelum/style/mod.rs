...
use crate::engine::caelum::geometry::{Point, Rect, Size};
use crate::engine::caelum::style_helpers::CaelumAuto as _;
use core::fmt::Debug;
...
impl_parse_for_keyword_enum!(Display,
    "none" => None,
    "flex" => Flex,
    "grid" => Grid,
    "block" => Block,
...
impl_parse_for_keyword_enum!(Position,
    "relative" => Relative,
    "absolute" => Absolute,
);
...
impl_parse_for_keyword_enum!(BoxSizing,
...
///
/// In Caelum, we only implement the layout related secondary effects as we are not concerned with drawing/painting. The amount of space reserved for
...
impl_parse_for_keyword_enum!(Overflow,
    "visible" => Visible,
    "hidden" => Hidden,
    "clip" => Clip,
    "scroll" => Scroll,
...
impl_parse_for_keyword_enum!(Direction,
    "ltr" => Ltr,
    "rtl" => Rtl,
);
...
mod tests {
    ...
    use super::Style;
    use crate::engine::caelum::util::sys::DefaultCheapStr;
    use crate::engine::caelum::{geometry::*, style_helpers::CaelumAuto as _};
    ...
    fn style_sizes() {
        ...
        fn assert_type_size<T>(expected_size: usize) {
            ...
            let name = name.replace("Caelum::geometry::", "");
            let name = name.replace("Caelum::style::dimension::", "");
            let name = name.replace("Caelum::style::alignment::", "");
            let name = name.replace("Caelum::style::flex::", "");
            let name = name.replace("Caelum::style::grid::", "");
