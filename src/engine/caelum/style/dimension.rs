...
use crate::engine::caelum::style_helpers::{FromLength, FromPercent, CaelumAuto, CaelumZero};

/// A unit of linear measurement
///
/// This is commonly combined with [`Rect`], [`Point`](crate::engine::caelum::geometry::Point) and [`Size<T>`](crate::engine::caelum::geometry::Size).
#[derive(Copy, Clone, PartialEq, Debug)]
pub struct LengthPercentage(pub(crate) CompactLength);
impl CaelumZero for LengthPercentage {
...
impl CaelumZero for LengthPercentageAuto {
    const ZERO: Self = Self(CompactLength::ZERO);
}
impl CaelumAuto for LengthPercentageAuto {
...
impl CaelumZero for Dimension {
    const ZERO: Self = Self(CompactLength::ZERO);
}
impl CaelumAuto for Dimension {
    const AUTO: Self = Self(CompactLength::AUTO);
}
