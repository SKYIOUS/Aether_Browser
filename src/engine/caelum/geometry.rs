...
use crate::engine::caelum::{style::Dimension, util::sys::f32_min};
use core::ops::{Add, Sub};

use crate::engine::caelum::style::FlexDirection;
...
impl AbstractAxis {
    ...
    /// This is currently always true, but will change if Caelum ever implements the `writing_mode` property
    #[inline]
