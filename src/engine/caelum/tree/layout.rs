...
use crate::engine::caelum::geometry::{AbsoluteAxis, Line, Point, Rect, Size};
use crate::engine::caelum::style::AvailableSpace;
use crate::engine::caelum::style_helpers::CaelumMaxContent;
use crate::engine::caelum::util::sys::{f32_max, f32_min};
...
pub enum DetailedLayoutInfo {
    /// Enum variant for [`DetailedGridInfo`](crate::engine::caelum::compute::grid::DetailedGridInfo)
    Grid(Box<crate::engine::caelum::compute::grid::DetailedGridInfo>),
