...
use crate::engine::caelum::geometry::{Rect, Size};
use crate::engine::caelum::style::{Dimension, LengthPercentage, LengthPercentageAuto};
use crate::engine::caelum::style_helpers::CaelumZero;
use crate::engine::caelum::CompactLength;
...
pub trait ResolveOrZero<TContext, TOutput: CaelumZero> {
...
impl<In, Out: CaelumZero, T: ResolveOrZero<In, Out>> ResolveOrZero<Size<In>, Size<Out>> for Size<T> {
    /// Converts any `parent`-relative values for size into an absolute size
...
impl<In: Copy, Out: CaelumZero, T: ResolveOrZero<In, Out>> ResolveOrZero<Size<In>, Rect<Out>> for Rect<T> {
...
impl<Out: CaelumZero, T: ResolveOrZero<Option<f32>, Out>> ResolveOrZero<Option<f32>, Rect<Out>> for Rect<T> {
    /// Converts any `parent`-relative values for Rect into an absolute Rect
...
mod tests {
    ...
    where
        ...
        Out: PartialEq + Debug + CaelumZero,
    {
    ...
    mod maybe_resolve_dimension {
        use super::mr_case;
        use crate::engine::caelum::style::Dimension;
    ...
    mod resolve_or_zero_rect_dimension_to_rect_f32_via_option {
        use super::roz_case;
        use crate::engine::caelum::geometry::Rect;
        use crate::engine::caelum::style::Dimension;
