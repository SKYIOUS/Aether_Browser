...
//!
//! Caelum uses two coordinate systems to refer to grid lines (the gaps/gutters between rows/columns):
//!
...
//!
//! Caelum also uses two coordinate systems to refer to grid tracks (rows/columns):
//!
...
//!
use crate::engine::caelum::{compute::grid::OriginZeroLine, geometry::Line};
use core::ops::Range;
