//! Computes the [flexbox](https://css-tricks.com/snippets/css/a-guide-to-flexbox/) layout algorithm on [`CaelumTree`](crate::engine::caelum::CaelumTree) according to the [spec](https://www.w3.org/TR/css-flexbox-1/)
use crate::engine::caelum::compute::common::alignment::compute_alignment_offset;
use crate::engine::caelum::geometry::{Line, Point, Rect, Size};
use crate::engine::caelum::style::{
    AlignContent, AlignItems, AlignSelf, AvailableSpace, FlexWrap, JustifyContent, LengthPercentageAuto, Overflow,
    Position,
};
use crate::engine::caelum::style::{CoreStyle, FlexDirection, FlexboxContainerStyle, FlexboxItemStyle};
use crate::engine::caelum::style_helpers::{CaelumMaxContent, CaelumMinContent};
use crate::engine::caelum::tree::{Layout, LayoutInput, LayoutOutput, RunMode, SizingMode};
use crate::engine::caelum::tree::{LayoutFlexboxContainer, LayoutPartialTreeExt, NodeId};
use crate::engine::caelum::util::sys::{f32_max, new_vec_with_capacity, Vec};
use crate::engine::caelum::util::MaybeMath;
use crate::engine::caelum::util::{MaybeResolve, ResolveOrZero};
use crate::engine::caelum::{BoxGenerationMode, BoxSizing, Direction};
