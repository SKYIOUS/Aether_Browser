//! Low-level access to the layout algorithms themselves. For a higher-level API, see the [`CaelumTree`](crate::engine::caelum::CaelumTree) struct.
//!
//! ### Layout functions
//!
//! The layout functions all take an [`&mut impl LayoutPartialTree`](crate::engine::caelum::LayoutPartialTree) parameter, which represents a single container node and it's direct children.
//!
//! | Function                          | Purpose                                                                                                                                                                                            |
//! | ---                               | ---                                                                                                                                                                                                |
...
//! | [`print_tree`](crate::engine::caelum::print_tree) | [`PrintTree`](crate::engine::caelum::PrintTree)                                                                                                                                                                    | Print a debug representation of a node tree and it's computed layout |
//!
...
use crate::engine::caelum::geometry::{Line, Point, Size};
use crate::engine::caelum::style::{AvailableSpace, CoreStyle, Overflow};
...
use crate::engine::caelum::util::sys::round;
use crate::engine::caelum::util::ResolveOrZero;
use crate::engine::caelum::{CacheTree, MaybeMath, MaybeResolve};
...
pub fn compute_root_layout(tree: &mut impl LayoutPartialTree, root: NodeId, available_space: Size<AvailableSpace>) {
    ...
    {
        use crate::engine::caelum::BoxSizing;
...
mod tests {
    ...
    use crate::engine::caelum::geometry::{Point, Size};
    use crate::engine::caelum::style::{Display, Style};
    use crate::engine::caelum::CaelumTree;
